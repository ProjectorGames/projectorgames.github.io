...
Here, I will embedd image from local assets which goes into `assets` directory in game's `root` directory. Choose a specific image, related to particular post. I chose to name the image `test-page-image-1.jpg`, which I will embedd as:
